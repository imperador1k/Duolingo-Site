...
const translations = {
  pt: {
    ...
    "features.1.desc": "Aprender com o Duoclone é divertido, e pesquisas comprovam que funciona mesmo! Com lições rápidas e curtinhas, você ganha pontos e desbloqueia novos níveis enquanto aprende a se comunicar na vida real.",
    ...
    "test.title": "Duoclone English Test",
    ...
    "schools.title": "Duoclone for Schools",
    ...
    "abc.title": "Duoclone ABC",
    "abc.desc": "Do ensino de idiomas à alfabetização! Com lições divertidas de fônica e histórias encantadoras, o Duoclone ABC ajuda crianças de 3 a 8 anos a aprender a ler e escrever — totalmente grátis!",
    "abc.cta": "SAIBA MAIS SOBRE O ABC",
    "cta.title": "Aprenda um idioma com o Duoclone",
    "footer.rights": "© 2026 Duoclone Clone. Todos os direitos reservados."
  },
  en: {
    "header.login": "Log in",
    ...
    "features.1.desc": "Learning with Duoclone is fun, and research shows that it works! With quick, bite-sized lessons, you'll earn points and unlock new levels while gaining real-world communication skills.",
    ...
    "abc.title": "Duoclone ABC",
    "abc.desc": "From language learning to literacy! With fun phonics lessons and charming stories, Duoclone ABC helps children ages 3-8 learn to read and write—completely free!",
    "abc.cta": "LEARN MORE ABOUT ABC",
    "cta.title": "Learn a language with Duoclone",
    "footer.rights": "© 2026 Duoclone Clone. All rights reserved."
  }
} as const;
