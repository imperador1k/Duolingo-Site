    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          >
            <div className="relative h-40 sm:h-48 bg-linear-to-b from-orange-50/50 to-white flex items-center justify-center pt-4">
              <button 
                onClick={onClose}
            ...
            <div className="relative flex-1 overflow-hidden flex flex-col">
              <div className="flex-1 overflow-y-auto scrollbar-none px-8 sm:px-12 pb-6">
                <div className="text-center mb-10">
                  ...
                  <div className="h-1.5 w-20 bg-orange-400 rounded-full mx-auto opacity-30" />
                </div>
                ...
                <div className="space-y-10">
                  ...
                  <div className="flex flex-col sm:flex-row gap-6 items-center sm:items-start group">
                    ...
                    <div className="text-center sm:text-left">
                      <h3 className="font-black text-[#1f2937] text-xl mb-2 uppercase tracking-wide">
                        {t('games.modal.feature2.title')}
                      </h3>
                      <p className="text-[#4b4b4b] font-bold text-lg leading-relaxed opacity-80">
                        {t('games.modal.feature2.desc')}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-6 items-center sm:items-start group">
                    ...
                    <div className="text-center sm:text-left">
                      <h3 className="font-black text-[#1f2937] text-xl mb-2 uppercase tracking-wide">
                        {t('games.modal.feature3.title')}
                      </h3>
                      <p className="text-[#4b4b4b] font-bold text-lg leading-relaxed opacity-80">
                        {t('games.modal.feature3.desc')}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="px-8 sm:px-12 pb-8 pt-4 bg-white border-t border-gray-50">
                <Button3D 
                  ...
                  fullWidth 
                  onClick={onClose}
                  className="py-5 text-xl bg-orange-500 hover:bg-orange-600 border-orange-700 shadow-[0_6px_0_0_#c2410c] rounded-3xl"
                >
                  {t('games.modal.close')}
                </Button3D>
              </div>
