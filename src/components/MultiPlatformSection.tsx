  ...
  return (
    <section className="min-h-screen bg-[#ddf4ff] flex flex-col items-center py-24 px-6 relative overflow-hidden">
      ...
      <div className="relative z-30 text-center flex flex-col items-center gap-8 mb-16">
        ...
        {/* Juicy Store Buttons (Staggered Entrance) */}
        <motion.div 
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.2 }}
        ...
        >
          ...
          <motion.button 
            ...
            className="group flex items-center gap-2.5 bg-black text-white px-5 sm:px-7 py-3 rounded-2xl border-b-4 border-gray-800 active:border-b-0 active:translate-y-1 transition-all cursor-pointer"
          >
      ...
      <motion.div 
        ...
        className="relative w-full flex-1 min-h-[400px] md:max-h-[600px] mt-10 flex justify-center items-center overflow-visible px-4"
      >
        ...
        <motion.div 
          variants={{
            ...
            visible: { opacity: 1, scale: 1, transition: { type: "spring", stiffness: 80, delay: 0.1 } }
          }}
